...
object GamePlayConstants:
  ...
  val GENERATOR_WIZARD_ELIXIR_PER_SECOND: Int = 5
  val GENERATOR_WIZARD_COOLDOWN: Long = 5000L
  ...
  val FIRE_WIZARD_COOLDOWN: Long = 10000L

  val ICE_WIZARD_HEALTH: Int = 90
  val ICE_WIZARD_COST: Int = 250
  val ICE_WIZARD_ATTACK_DAMAGE: Int = 30
  val ICE_WIZARD_RANGE: Double = 3.0
  val ICE_WIZARD_COOLDOWN: Long = 1000L
...
object ViewConstants:
  ...
  val INFO_CONTENT_AREA_HEIGHT: Int = 350
